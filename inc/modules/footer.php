        ...
        <div class="row">
        <div class="col-md-6 map-area-left">
        <h3>Building 3, Chiswick Business Park, 566 Chiswick High Rd, Chiswick, W4 5YA</h3>     
          <div class="map">
            <img class="img-responsive" src="../../inc/img/chiswick-loc.png" alt="Computrad Chiswick">
          </div>

        </div>
        <div class="col-md-6 map-area-right">
        <h3>Smithfield Business Centre, 5 St John's Lane, London, EC1M 4BH</h3>
          <div class="map">
            <img class="img-responsive" src="../../inc/img/city-loc.png" alt="Computrad London">
          </div>
        </div>
        </div>
        </section>
  ...
  <div class="row botnav-row">
  <div class="col-md-2 botnav">
    <button onclick="dropdown1()" class="dropbtn">IT Support</button>
    </div>

    <div id="dropdown1" class="botnav-sub">
    <div class="row">
    ...
    <div class="col-md-2 botnav">
    <button onclick="dropdown2()" class="dropbtn">IT Security</button>
    </div>

    <div id="dropdown2" class="botnav-sub">
    <div class="row">
    <div class="col-md-3 botnav-col">
    <h3>Protection</h3>
    ...
    <div class="col-md-2 botnav">
    <button onclick="dropdown3()" class="dropbtn">Managed IT</button>
    </div>

    <div id="dropdown3" class="botnav-sub">
    <div class="row">
    <div class="col-md-3 botnav-col">
    ...
    <a href="" class="botnav-sublink"><h4>Full IT Outsourcing</h4>
    <p>Fully outsource your IT Function</p></a>
    <a href="" class="botnav-sublink"><h4>IT Co-Sourcing</h4>
    <p>Part outsource your IT Function</p></a>
    <a href="" class="botnav-sublink"><h4>Outsourced Helpdesk</h4>
    <p>Dedicated business IT helpdesk</p></a>
    <a href="" class="botnav-sublink"><h4>Contract Staffing</h4>
    <p>Short term on site resources</p></a>
    </div>
    <div class="col-md-3 botnav-col">
    <h3>Resources</h3>
    <a href="" class="botnav-sublink"><h4>IT Buyer's Guide</h4>
    <p>The Computrad guide to buying IT services</p></a>
    <a href="" class="botnav-sublink"><h4>Why Outsource?</h4>
    <p>Benefits of outsourcing your IT function</p></a>
    <a href="" class="botnav-sublink"><h4>Looking to Switch?</h4>
    <p>How to Review your IT provider</p></a>
    <a href="" class="botnav-sublink"><h4>IT Management Problems</h4>
    <p>Find out about common IT pain points</p></a>
    </div>-->
    </div>
    </div>

    <div class="col-md-2 botnav">
    <button onclick="dropdown4()" class="dropbtn">IT Services</button>
    </div>

    <div id="dropdown4" class="botnav-sub">
    <div class="row">
    <div class="col-md-3 botnav-col">
    ...
    <div class="col-md-3 botnav-col">
    <h3 class="botnav-h3space"></h3>
    <a href="" class="botnav-sublink"><h4>Windows 2003 Migration</h4>
    <p>Fast Track Service for Windows 2003 Migration</p></a>
    </div>
    <div class="col-md-3 botnav-col">
    ...
    <div class="col-md-2 botnav">
    <button onclick="dropdown5()" class="dropbtn">IT Solutions</button>
    </div>
    <div id="dropdown5" class="botnav-sub">
    <div class="row">
    <div class="col-md-3 botnav-col">
    <h3>Network Solutions</h3>
    <a href="" class="botnav-sublink"><h4>Bandwidth Management</h4>
    <p>Full Management of Network traffic</p></a>
    <a href="" class="botnav-sublink"><h4>Deep Packet Inspection</h4>
    <p>Advanced DPI to ensure secure connectivity</p></a>
    <a href="" class="botnav-sublink"><h4>Patch Management</h4>
    <p>Management and Automation of Patching</p></a>
    <a href="" class="botnav-sublink"><h4>Vulnerability Management</h4>
    <p>Management of Network Vulnerabilities</p></a>
    </div>
    <div class="col-md-3 botnav-col">
    <h3>Optimisation</h3>
    <a href="" class="botnav-sublink"><h4>WAN Optimisation</h4>
    <p>Accelerate performance of Wide Area Networks</p></a>
    <a href="" class="botnav-sublink"><h4>Application management</h4>
    <p>Accelerate delivery of application content</p></a>
    </div>
    <div class="col-md-3 botnav-col">
    <h3>Virtualisation</h3>
    <a href="" class="botnav-sublink"><h4>Desktop Virtualisation</h4>
    <p>Management of Virtual Desktop Environment</p></a>
    <a href="" class="botnav-sublink"><h4>Server Virtualisation</h4>
    <p>Management of Virtual Server Environment</p></a>
    </div>
    <div class="col-md-3 botnav-col">
    </div>
    </div>
...
function dropdown1() {
    var dropdowns = document.getElementsByClassName("botnav-sub");
    var i;
