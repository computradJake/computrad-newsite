...
<html lang="en">
  ...
  <head>    
    <meta charset="utf-8">
    <meta name="description" content="Computrad's privacy policy and explanation of marketing and cookie policy">
    <meta name="keywords" content="Computrad Privacy Policy for IT Support">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <meta name="author" content="Computrad">
<?php include './inc/modules/headinglinks.php'; ?>
    <title>Computrad.co.uk Privacy Policy and Cookie Usage Policy for Marketing Purposes</title>
  </head>
            ...
            <div class="row">   
              <div class="col-md-12 col-sm-12 wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
                <div class="feature-item">
                  ...
                  <p class="intro">(1) Credit</p>
                  <p>We created this privacy policy using a free privacy policy form developed by SEQ Legal and available at www.website-law.co.uk. Other forms available from SEQ Legal include a part time employment agreement.</p>
                </div>
              </div>
             </div>
        ...
        <section id="main-services" class="section ">
          <div class="container"> 
            <div class="row">   
              <div class="col-md-12 col-sm-12 wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
                <div class="feature-item">
                  <p class="intro">(2) What information do we collect?</p>
            ...
            <div class="row">   
              <div class="col-md-12 col-sm-12 wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
                <div class="feature-item">
                  ...
                  <p>We [may] use [both] ["session" cookies] [and "persistent" cookies] on the website. [We will use the session cookies to: keep track of you whilst you navigate the website; and [other uses].] [We will use the persistent cookies to: enable our website to recognise you when you visit.]</p>
        ...
        <section id="main-services" class="section ">
          <div class="container"> 
            <div class="row">   
              <div class="col-md-12 col-sm-12 wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
                <div class="feature-item">
                  <p class="intro">(4) Using your personal information</p>
                  ...
                  <p>[(c) enable your use of the services available on the website;]
                  </p>
        ...
        <section id="main-services" class="section ">
          <div class="container"> 
            <div class="row">   
              <div class="col-md-12 col-sm-12 wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
                <div class="feature-item">
                  <p class="intro">[(6) International data transfers</p>
                  ...
                  <p>Information which you provide may be transferred to countries [(including [the United States], [Japan], [other countries])] which do not have data protection laws equivalent to those in force in the European Economic Area.</p>
        ...
        <section id="main-services" class="section main-feature-gray">
          <div class="container"> 
            <div class="row">   
              <div class="col-md-12 col-sm-12 wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
                <div class="feature-item">
                  <p class="intro">(7) Security of your personal information</p>
        ...
        <section id="main-services" class="section ">
          <div class="container"> 
            <div class="row">   
              <div class="col-md-12 col-sm-12 wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
                <div class="feature-item">
                  <p class="intro">(8) Policy amendments</p>
        ...
        <section id="main-services" class="section ">
          <div class="container"> 
            <div class="row">   
              <div class="col-md-12 col-sm-12 wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
                <div class="feature-item">
                  <p class="intro">(11) Updating information</p>
        ...
        <section id="main-services" class="section main-feature-gray">
          <div class="container"> 
            <div class="row">   
              <div class="col-md-12 col-sm-12 wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
                <div class="feature-item">
                  <p class="intro">(12) Contact</p>

<p>If you have any questions about this privacy policy or our treatment of your personal information, feel free to <a href="#contact">contact us</a></p>
                </div>
              </div>
             </div>
            </div>
        ...
        <section id="main-services" class="section ">
          <div class="container"> 
            <div class="row">   
              <div class="col-md-12 col-sm-12 wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
                <div class="feature-item">
                  <p class="intro">(13) Data controller</p>

<p>The data controller responsible in respect of the information collected on this website is Computrad (Europe) Holdings Ltd</p>
                </div>
              </div>
             </div>
            </div>
